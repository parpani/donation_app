...
const Donations = createSlice({
  ...
  reducers: {
    ...
    updateSelectedDonationId: (state, action) => {
      ...
      state.selectedDonationInformation = state.items.find(    //used to get the exact id that has been selected and pass the information that needs to be displayed in the next page
